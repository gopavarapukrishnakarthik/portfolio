        ...
        <div className="max-w-2xl ml-[4vw] flex flex-col items-start text-left">
          ...
          <Reveal delay={0.4}>
            <div className="mt-4 text-gray-600 text-lg md:text-xl leading-relaxed">
              <TypingAnimation
                text="Full Stack Developer and DevOps Engineer with 3 years of experience building, deploying, and scaling modern web applications. I enjoy crafting reliable backend systems, intuitive user interfaces, and smooth CI/CD workflows."
                duration={30}
              />
            </div>
          </Reveal>
